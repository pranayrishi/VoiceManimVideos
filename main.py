...
def generate_voiceover_script(topic, manim_script):
   prompt = f"Provide a 10-15 second, engaging, and educational explanation about the math concept '{topic}'. Ensure the explanation is clear, concise, and suitable for a voiceover in a video."

   response = openai.ChatCompletion.create(
       model="gpt-3.5-turbo",
       messages=[
           {"role": "system", "content": "You are an AI that generates concise, engaging educational explanations."},
           {"role": "user", "content": prompt}
       ]
   )
   ...
   #print("Generated AI-powered voiceover script:")
